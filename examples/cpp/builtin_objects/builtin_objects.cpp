...
int main( int argc, char ** argv ) {
   ...
   for (size_t i = 0; i < 10; ++i) {
      point_t point(glm::vec3((float)rand() / RAND_MAX + cur_cell_min_x, (float)rand() / RAND_MAX + cur_cell_min_y, (float)rand() / RAND_MAX - 0.5));
      ...
      //scene->add_object(point_t(glm::vec3((float)rand() / RAND_MAX + cur_cell_min_x, (float)rand() / RAND_MAX + cur_cell_min_y, (float)rand() / RAND_MAX - 0.5), glm::vec3(0, 1, 0), shader_prog));
