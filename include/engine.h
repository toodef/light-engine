...
namespace SE
{
   ...
   class engine_t;
   typedef std::shared_ptr<engine_t> engine_ptr_t;
   ...
   public:
      ...
      material_ptr_t create_material(const string & vertex_shader, const string & fragment_shader, const string & geomerty_shader = "");
   ...
   private:
      ...
      float view_angle_, near_, far_;

      scene::scene_t scene_, static_scene_, double_scene_;

      bool draw_frustum_, enable_fake_cam_;

      buffer_ptr_t bounding_box_buffer_, tf_buffer_;
