...
texture_t::texture_t( string const & file_name, texture_manager_ptr_t const & manager
...
texture_t::texture_t( string const & file_name, texture_manager_ptr_t const & manager, GLenum type ) :
     manager_(manager)
   , type_(type)
{
  switch(type_)
...
texture_t::texture_t( vector<string> const & files_name, texture_manager_ptr_t const & manager
                     ,tex_params_t const & params ) :
     manager_(manager)
   , type_(GL_TEXTURE_CUBE_MAP)
{
   ...
   load_cube_map(files_name, params);
...
texture_ptr_t texture_manager_t::create_texture( const string & file_name
                                                ,tex_params_t const & params )
{
   texture_ptr_t new_texture(new texture_t(file_name, this, params));

   return new_texture;
}

texture_ptr_t texture_manager_t::create_texture( const string & file_name, GLenum type )
{
   texture_ptr_t new_texture(new texture_t(file_name, this, type));

   return new_texture;
}

texture_ptr_t texture_manager_t::create_texture( const vector<string> & files_name
                                                ,tex_params_t const & params )
{
   texture_ptr_t new_texture(new texture_t(files_name, this, params));

   return new_texture;
}

texture_ptr_t texture_manager_t::create_texture( const vector<string> & files_names )
{
   texture_ptr_t new_texture(new texture_t(files_names, this));
